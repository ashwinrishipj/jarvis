      ...
      <div className="container-fluid" style={{ backgroundColor: "#1a212c" }}>
        <div className="row">
          ...
          >
            ...
            <div
              className="alert alert-outline-success my-card footerMyProfile"
              style={{ bordercolor: "whitesmoke" }}
              onClick="window.open('https://medium.com/@ashwinrishipj/javascript-the-fuzz-about-hoisting-variable-shadowing-and-closure-b8937bae349e')"
              target={"_blank"}
            >
            ...
            <div
              className="alert alert-outline-danger my-card footerMyProfile"
              style={{ bordercolor: "whitesmoke;" }}
              onClick=" window.open(' https://medium.com/@ashwinrishipj/html-and-css-the-fun-language-of-all-b4214db90fad')"
              target={"_blank"}
            >
